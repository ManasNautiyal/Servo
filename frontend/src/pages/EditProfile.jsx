    ...
    <div className="max-w-3xl mx-auto py-6 space-y-6 px-4">
      ...
      <div className="grid gap-8 md:grid-cols-3">
        ...
        <div className="md:col-span-1 space-y-6">
          {/* Avatar box */}
          <div className="rounded-xl border border-gray-100 bg-white p-5 shadow-sm dark:border-darkBorder dark:bg-darkCard text-center space-y-4">
            ...
            <div className="flex flex-col items-center">
              {user?.profile_picture ? (
                <img
                  ...
                  alt={user?.name}
                  className="h-24 w-24 rounded-full object-cover ring-2 ring-brand-100 dark:ring-brand-900"
                />
              ) : (
              ...
              <label className="mt-4 inline-flex items-center space-x-1.5 rounded-lg border border-gray-200 bg-white px-3 py-2 text-xs font-semibold text-gray-700 cursor-pointer hover:bg-gray-50 dark:border-darkBorder dark:bg-darkBg dark:text-gray-300 dark:hover:bg-darkCard">
          ...
          {/* Resume Upload box */}
          <div className="rounded-xl border border-gray-100 bg-white p-5 shadow-sm dark:border-darkBorder dark:bg-darkCard text-center space-y-4">
            <h3 className="text-xs font-bold text-gray-400 uppercase tracking-wider">Placement Resume</h3>
            <div className="flex flex-col items-center space-y-2">
              <FileText className={`h-12 w-12 ${user?.resume_url ? 'text-brand-500' : 'text-gray-300'}`} />
              <p className="text-[10px] text-gray-400">PDF, DOC, or DOCX formats</p>
              
              <label className="mt-2 inline-flex items-center space-x-1.5 rounded-lg border border-gray-200 bg-white px-3 py-2 text-xs font-semibold text-gray-700 cursor-pointer hover:bg-gray-50 dark:border-darkBorder dark:bg-darkBg dark:text-gray-300 dark:hover:bg-darkCard">
                <Upload className="h-3.5 w-3.5" />
        ...
        <div className="md:col-span-2">
          <form onSubmit={handleSubmit(onSubmit)} className="rounded-xl border border-gray-100 bg-white p-6 shadow-sm dark:border-darkBorder dark:bg-darkCard space-y-6">
            ...
            {/* GitHub Profile */}
            <div>
              <label htmlFor="github_link" className="block text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">
                GitHub URL
              </label>
            ...
            {/* Skills tags list */}
            <div>
              <label htmlFor="skills" className="block text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">
              ...
              <input
                ...
                className="mt-1 block w-full rounded-xl border border-gray-200 bg-gray-50/50 py-2.5 px-3 text-sm focus:border-brand-500 focus:outline-none dark:border-darkBorder dark:bg-darkBg dark:text-white"
              />
              <p className="mt-1 text-[10px] text-gray-400">Separate skills using commas. Example: Java, React, Photoshop</p>
            </div>

            {/* Biography */}
            <div>
              <label htmlFor="bio" className="block text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">
                Profile Biography
              </label>
              <textarea
                id="bio"
            ...
            <div className="flex justify-end gap-3 pt-3">
              <button
                ...
                className="rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm font-semibold text-gray-700 hover:bg-gray-50 dark:border-darkBorder dark:bg-darkBg dark:text-gray-300 dark:hover:bg-darkCard"
              >
                Cancel
              </button>
              <button
                type="submit"
                disabled={submitting}
                className="rounded-xl bg-brand-600 px-6 py-2.5 text-sm font-semibold text-white shadow-md hover:bg-brand-500 dark:bg-brand-700 dark:hover:bg-brand-600 disabled:opacity-75"
              >
